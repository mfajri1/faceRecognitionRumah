...
===================================================================
UPDATED: LOGIN ADMIN INTERFACE BEFORE FACE REGISTRATION
"""
...
class App(tk.Tk):
    ...
    # ============================================================
    # 1. HALAMAN UTAMA (SCANNING WAJAH)
    # ============================================================
    def build_sistem_utama(self):
        ...
        # TOMBOL "Daftar Wajah" SEKARANG MENGARAH KE HALAMAN LOGIN ADMIN
